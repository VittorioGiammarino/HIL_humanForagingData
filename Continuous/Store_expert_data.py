...
TrainingSet, Labels, Trajectories, Rotation, Time, _, _, _, _, _ = Show_DataSet(Folders, 'distr_only')
_,_,_,_,_, Reward_eval_human, Real_Traj_eval_human, Real_Reward_eval_human, Real_Time_eval_human, Coins_location = Show_DataSet(Folders, 'full_coins')
