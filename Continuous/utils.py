...
# =============================================================================
    ...
    for folder in Folders:
        for experiment in range(1,11):
            True_traj, True_time, Training_set_single_traj, Labels_single_traj, Time_single_traj, psi_single_traj, coin_direction_single_traj, reward_single_traj, real_reward, coin_location = World.Foraging.ProcessData(folder, experiment, coins)
