...
class TanhGaussianHierarchicalActor:
    ...
    class BatchBW(object):
        ...
        def Pi_combined(self, ot, ot_past, a, b, Pi_hi_parameterization, Pi_lo_parameterization, Pi_b_parameterization, state, option_space):
            ...
            Pi_lo_eval = TanhGaussianHierarchicalActor.BatchBW.Pi_lo(self, a, Pi_lo_parameterization, state).clamp(1e-10,1e10) #.clamp(0.0001,1) # since this is no longer a probability
    ...
    # =============================================================================
            ...
            for i in range(option_space):
                ...
                log_likelihood_pi_lo = TanhGaussianHierarchicalActor.BatchBW.get_log_likelihood_pi_lo(self, mean, std, Labels).cpu()
