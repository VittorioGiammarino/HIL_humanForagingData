...
[trajBW, controlBW, OptionBW, 
 TerminationBW, flagBW]=sim.HierarchicalPolicySim(Trained_triple, ED.zeta, ED.mu, ED.max_epoch, Trajs, ED.option_space, ED.size_input, Labels_dict_rad, speed, time)    
    
# %%

fig = plt.figure()
plot_traj = plt.scatter(trajBW[0][:,0], Expert_trajs_generated[traj][:,3], c=Expert_trajs_generated[traj][:,1], marker='o', cmap='cool')
cbar = fig.colorbar(plot_traj, ticks=[10, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500])
cbar.ax.set_yticklabels(['t = 0','t = 50', 't = 100', 't = 150', 't = 200', 't = 250', 't = 300', 't = 350', 't = 400', 't = 450', 't = 500'])
plt.xlabel('x')
plt.ylabel('y')
